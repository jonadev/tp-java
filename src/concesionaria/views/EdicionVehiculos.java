 ...
 * @author kbz
 */
public class EdicionVehiculos extends javax.swing.JFrame {

    /**
     * Creates new form ListadoVehiculos
     */
     public EdicionVehiculos() {
        initComponents();
    }
    
    public EdicionVehiculos(int idVehiculo) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EdicionVehiculos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EdicionVehiculos().setVisible(true);
            }
        });
    }
